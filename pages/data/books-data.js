window.READING_SHELF_BOOKS = [
  ...
  },
  {
    ...
    "readingTime": 7260,
    "detail": {
      "summary": "作者用平淡温馨的布道语气，充满博爱地传递正念的真谛。教会了我呼吸——无意识憋气源于Ni过度运转的身体反应，觉察呼吸就是松开Ni的闸。正念的目的不是保持正念，而是觉察到自己的念头漂移，不评判地拉回。",
      "thesis": "正念的本质不是维持专注状态，而是在觉察到分心时不带评判地回到当下。",
      "reader": "INTJ — 憋气是Ni在憋，呼吸自由是Se在接管。",
      "distance": "零距离 — 正在改变我的身体反应模式",
      "originalFeeling": "一行禅师的文字没有宗教感，却有一种奇怪的接近妈妈读睡前故事的安心感。他不是在教一个技巧，是在告诉你活着可以这样简单。",
      "collisions": [],
      "scanDate": "2026-06-26",
      "scanTarget": ""
    }
